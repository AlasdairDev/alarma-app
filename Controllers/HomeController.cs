            ...
            <head>
              ...
              <style>
                ...
                /* Light-violet "day" theme via a transparent tint DIV laid over the map.
                   ...
                   rgba(170,90,255,0.40), the on-brand violet from the build everyone liked. The thin-film
                   experiment washed the map structure out, so we're back to this fuller tint and instead lean
                   on a hard contrast boost on the tiles below (see the filter rule) to make the text punch
                   through it. pointer-events:none lets every
